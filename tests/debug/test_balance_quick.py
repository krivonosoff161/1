...
from src.balance import AdaptiveBalanceManager, create_default_profiles, BalanceProfile
...
def test_balance_manager():
    ...
    print(f"✅ Adapted TP: {adapted['tp_multiplier']} (was {regime_params['tp_multiplier']})")
    print(f"✅ Adapted SL: {adapted['sl_multiplier']} (was {regime_params['sl_multiplier']})")
