...
class PositionScalingManager:
    ...
    def _get_scaling_config(
        ...
        if not scaling_config:
            # Fallback на агрессивные параметры по умолчанию
            default_config = {
                "max_additions": 7,
