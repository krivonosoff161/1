...
class FastADX:
    ...
    def is_trend_strong(self) -> bool:
        """
        Проверка, сильный ли тренд.
        
        Returns:
            True если ADX > threshold
        """
    ...
    def get_trend_direction(self) -> str:
        ...
        Returns:
            "long" если восходящий тренд
            "short" если нисходящий тренд
            "neutral" если боковой рынок
        """
        di_plus = self.get_current_di_plus()
        di_minus = self.get_current_di_minus()
        
        if di_plus > di_minus + 2:
            return "long"
        elif di_minus > di_plus + 2:
            return "short"
        else:
            return "neutral"
