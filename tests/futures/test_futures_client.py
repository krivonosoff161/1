...
class TestOKXFuturesClient:
    ...
    async def test_make_request_success(self):
        ...
        mock_response = {"code": "0", "data": [{"test": "data"}]}
    ...
    async def test_make_request_error(self):
        ...
        mock_response = {"code": "50001", "msg": "API error"}
    ...
    async def test_get_margin_info(self):
        ...
        mock_response = {
            "code": "0",
            "data": [{"eq": "1000.0", "liqPx": "45000.0", "mgnRatio": "0.15"}],
        }
    ...
    async def test_set_leverage(self):
        ...
        mock_response = {"code": "0", "data": [{"result": "true"}]}
    ...
    async def test_place_futures_order_market(self):
        ...
        mock_response = {"code": "0", "data": [{"ordId": "12345"}]}

        with patch.object(self.client, "_make_request", return_value=mock_response):
            result = await self.client.place_futures_order(
                symbol="BTC-USDT", side="buy", size=0.01, order_type="market"
            )
    ...
    async def test_place_futures_order_limit(self):
        ...
        mock_response = {"code": "0", "data": [{"ordId": "12346"}]}
    ...
    async def test_place_oco_order(self):
        ...
        mock_response = {"code": "0", "data": [{"ordId": "12347"}]}
    ...
    async def test_get_positions_with_symbol(self):
        ...
        mock_response = {
            "code": "0",
            "data": [{"instId": "BTC-USDT-SWAP", "pos": "0.01", "posSide": "long"}],
        }
    ...
    async def test_error_handling(self):
        ...
        mock_response = {"code": "50001", "msg": "Invalid API key"}
