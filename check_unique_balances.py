...
log_dir = Path(r'C:\Users\krivo\simple trading bot okx\logs\futures\archived\logs_2025-12-01_21-39-44')
...
for log_file in all_logs:
    try:
        ...
        for line in lines:
            # Расширяем поиск
            if any(x in line.lower() for x in ['баланс', 'balance', 'equity', 'available', 'margin', 'total']):
