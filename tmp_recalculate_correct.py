...
for balance in balances:
    ...
    print(f"   Номинальный объем: ${notional_current:.2f} ({(notional_current/balance)*100:.1f}% баланса)")
    print(f"   Запас: ${balance - margin_current:.2f} ({((balance - margin_current)/balance)*100:.1f}%)")
