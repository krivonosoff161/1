...
from src.config import BotConfig, APIConfig, ScalpingConfig, RiskConfig, BalanceProfileConfig
...
class TestWebSocketBalanceIntegration:
    ...
    def test_orchestrator_initialization_with_balance(self, mock_config_with_balance, mock_okx_client):
        """Тест инициализации оркестратора с баланс менеджером"""
        orchestrator = WebSocketScalpingOrchestrator(mock_config_with_balance, mock_okx_client)
    ...
    def test_balance_manager_profile_determination(self, mock_config_with_balance, mock_okx_client):
    ...
    def test_balance_manager_parameter_adaptation(self, mock_config_with_balance, mock_okx_client):
        ...
        adapted = orchestrator.balance_manager.apply_to_regime_params(regime_params, "trending")
    ...
    def test_balance_manager_position_sizing(self, mock_config_with_balance, mock_okx_client):
    ...
    def test_balance_manager_profile_switching(self, mock_config_with_balance, mock_okx_client):
    ...
    def test_balance_manager_events_tracking(self, mock_config_with_balance, mock_okx_client):
    ...
    def test_balance_manager_statistics(self, mock_config_with_balance, mock_okx_client):
        """Тест статистики баланс менеджера"""
        orchestrator = WebSocketScalpingOrchestrator(mock_config_with_balance, mock_okx_client)
        
        # Устанавливаем профиль и создаем события
        orchestrator.balance_manager.update_balance(2000.0)
        orchestrator.balance_manager.check_and_update_balance("position_opened", symbol="ETH-USDT")
    ...
    def test_balance_manager_recommendations(self, mock_config_with_balance, mock_okx_client):
        ...
        small_recommendations = orchestrator.balance_manager.get_profile_recommendations()
        ...
        large_recommendations = orchestrator.balance_manager.get_profile_recommendations()
    ...
    def test_orchestrator_stats_with_balance(self, mock_config_with_balance, mock_okx_client):
...
if __name__ == "__main__":
    ...
    # Создаем фикстуры
    from src.config import APIConfig, ScalpingConfig, RiskConfig, BotConfig
