...
def analyze_positions():
    ...
    # Читаем CSV
    positions = []
    with open("ANALYSIS_PACKAGE_2025-12-23/trades_2025-12-23.csv", "r", encoding="utf-8") as f:
        ...
        for row in reader:
            ...
            if record_type == "positions_open":
                ...
                clean_row = {k: v.strip('"').strip() if v else "" for k, v in row.items()}
    ...
    for pos in positions:
        ...
        print(f"{status} {symbol} ({side}): entry=${entry_price:.2f}, current=${current_price:.2f}, "
