    ...
    try:
        ...
        try:
            connect_result = await asyncio.wait_for(
                orchestrator.websocket_manager.connect(), 
                timeout=5.0
            )
            ...
            if connect_result:
                ...
                for symbol in config.trading.symbols:
                    ...
                    for interval in config.scalping.candle_intervals:
                        ...
                        await orchestrator.websocket_manager.subscribe_candles(symbol, interval)
                ...
                try:
                    ...
                    await asyncio.wait_for(
                        orchestrator.websocket_manager.start_listening(),
                        timeout=3.0
                    )
