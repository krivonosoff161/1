...
try:
    from src.indicators.talib_wrapper import (
        TALibATR, TALibEMA, TALibMACD, TALibRSI, TALibSMA, TALibBollingerBands
    )
    TALIB_AVAILABLE = True
    # ✅ ЛОГИРОВАНИЕ: Логируем успешную загрузку TA-Lib
    from loguru import logger
    logger.info("✅ TA-Lib обертки загружены успешно - используется оптимизированная версия индикаторов")
