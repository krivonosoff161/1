...
with open('logs/futures/futures_main_2025-12-27.log', 'r', encoding='utf-8', errors='ignore') as f:
    lines = f.readlines()
...
for i, line in enumerate(lines):
    if 'SOL' in line.upper():
        keywords = ['ORDER', 'LIMIT', 'MARKET', 'CANCEL', 'ОТМЕН', 'РАЗМЕЩЕН', 'PLACED', 
                   'ОТКРЫТ', 'ЗАКРЫТ', 'OPEN', 'CLOSE', 'SUCCESS', 'PROFIT', 'ПРИБЫЛЬ', 
                   '0.77', '.77', 'PNL', 'ИСПОЛНЕН', 'FILLED', 'рыночн', 'лимит']
