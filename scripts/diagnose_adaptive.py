...
def diagnose_adaptive_params():
    ...
    try:
        ...
        print(
            f"✅ Пороги: small_threshold={small_threshold}, large_threshold={large_threshold}"
        )
        ...
        from src.strategies.scalping.futures.config.config_manager import \
            ConfigManager
        ...
        for balance in test_balances:
            tp_factor, sl_factor = provider._calculate_balance_adaptation_factors(
                balance
            )
