...
print(f"\n📊 ТЕКУЩЕЕ ИСПОЛЬЗОВАНИЕ:")
print(
    f"   Общий номинальный объем: ${total_notional:.2f} ({notional_percent:.1f}% баланса)"
)
print(f"   Общая маржа: ${total_margin:.2f} ({usage_percent:.1f}% баланса)")
print(
    f"   НЕИСПОЛЬЗУЕМЫЙ БАЛАНС: ${balance - total_margin:.2f} ({100 - usage_percent:.1f}%)"
)
...
print(
    f"   Общий номинальный объем: ${total_notional_5x:.2f} ({notional_percent_5x:.1f}% баланса)"
)
...
print(f"   Позиций: {current_max_positions}")
print(
    f"   Общий номинальный объем: ${total_notional_10x:.2f} ({notional_percent_10x:.1f}% баланса)"
)
...
print(f"   Позиций: {current_max_positions}")
print(
    f"   Общий номинальный объем: ${total_notional_3:.2f} ({notional_percent_3:.1f}% баланса)"
)
...
print(f"   Позиций: {current_max_positions}")
print(
    f"   Общий номинальный объем: ${total_notional_4:.2f} ({notional_percent_4:.1f}% баланса)"
)
...
print(f"   Позиций: {current_max_positions}")
print(
    f"   Общий номинальный объем: ${total_notional_5:.2f} ({notional_percent_5:.1f}% баланса)"
)
