...
async def main():
    ...
    try:
        ...
        if not config_path.exists():
            ...
            logger.info("💡 Создайте файл config/config_futures.yaml с вашими настройками")
            return
        ...
        if not config.api.key or config.api.key == "your_api_key_here":
            ...
            logger.info("💡 Отредактируйте config/config_futures.yaml и укажите ваши API ключи")
            return
