...
echo DEBUG CSV files moved: !debugcsvcount!
echo.
...
echo TRADE CSV files moved: !tradescount!
echo.
...
echo JSON files moved: !jsoncount!
echo.
...
echo EXTRACTED files moved: !extractedcount!
echo.
...
echo TEMP_EXTRACTED files moved: !tempextractedcount!
echo.
