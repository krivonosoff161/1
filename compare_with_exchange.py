...
class ExchangeDataComparator:
    ...
    async def fetch_exchange_positions_history(self, start_date: datetime, end_date: datetime):
    ...
    def compare_data(self):
        ...
        if self.bot_trades and self.exchange_positions:
            ...
            exchange_total_pnl = sum(float(p.get("realizedPnl", 0)) for p in self.exchange_positions)
    ...
    def save_comparison_report(self):
        ...
        report = {
            ...
            "exchange_positions_sample": self.exchange_positions[:10]  # Первые 10 для примера
        }
