...
class TestPnLCalculations:
    ...
    def test_long_pnl_with_commission(self):
        ...
        assert (
            abs(net_pnl - expected_net_pnl) < 0.001
...
class TestTrailingStopLoss:
    ...
    def test_long_trailing_stop(self):
        ...
        assert (
            abs(stop_loss - expected_stop) < 0.001
...
class TestPositionSize:
    ...
    def test_position_size_calculation(self):
        ...
        expected_size = 0.2
        assert (
            abs(position_size_coins - expected_size) < 0.001
...
class TestMarginCalculations:
    ...
    def test_margin_calculation(self):
        ...
        assert (
            abs(margin_required - expected_margin) < 0.001
...
class TestSideNormalization:
    ...
    def test_side_sell_to_short(self):
        ...
        assert (
            position_side == "short"
        ), f"Ожидалось 'short', получено '{position_side}'"
...
class TestContractConversion:
    ...
    def test_contracts_to_coins(self):
        ...
        expected_size = 0.1
        assert (
            abs(size_in_coins - expected_size) < 0.001
