...
def get_default_parameters(regime: str, pair: str, system: str) -> Dict:
    ...
    # Параметры по парам
    pair_params = {
        'XRP-USDT': {'leverage_max': 10, 'position_size_min': 10, 'volatility_factor': 1.2},
        'ETH-USDT': {'leverage_max': 5, 'position_size_min': 0.01, 'volatility_factor': 1.0},
        'SOL-USDT': {'leverage_max': 8, 'position_size_min': 0.1, 'volatility_factor': 1.5},
        'DOGE-USDT': {'leverage_max': 15, 'position_size_min': 100, 'volatility_factor': 2.0},
        'BTC-USDT': {'leverage_max': 3, 'position_size_min': 0.001, 'volatility_factor': 0.8}
    }
...
def get_expected_results(regime: str, pair: str, system: str) -> Dict:
    ...
    expected_win_rate = base_expectations['min_win_rate'] * r_mult['win_rate_mult'] * p_mult['win_rate_mult'] * s_mult['win_rate_mult']
    expected_pnl = base_expectations['min_pnl_per_trade'] * r_mult['pnl_mult'] * p_mult['pnl_mult'] * s_mult['pnl_mult']
