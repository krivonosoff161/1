...
from src.balance.adaptive_balance_manager import (AdaptiveBalanceManager,
                                                  BalanceProfile,
...
class TestBalanceUpdateEvent:
    ...
    def test_balance_update_event_creation(self):
        ...
        event = BalanceUpdateEvent(
            event_type="position_opened", symbol="ETH-USDT", side="long", amount=100.0
        )
...
class TestAdaptiveBalanceManager:
    ...
    def test_get_profile_recommendations_large(self):
        ...
        )  # Нет рекомендаций для большого баланса
